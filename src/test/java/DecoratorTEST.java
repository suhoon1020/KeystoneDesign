...
public class DecoratorTEST {
    public static void main(String[]args){
        ...
        System.out.println("기본 수수료 : " + charge1.checkCharge(tradeItem));

        // 개수에 따른 수수료 방식
        charge1 = new ChangeChargeByCount(charge1);
        System.out.println("개수에 따른 할인 수수료 : " + charge1.checkCharge(tradeItem));

        // 가격에 따른 수수료 방식
        Charge charge2 = new BasicCharge();
        charge2 =new ChangeChargeByPrice(charge2);
        System.out.println("가격에 따른 할인 수수료 : " + charge2.checkCharge(tradeItem));

        // 개수 + 가격에 따른 수수료 방식
        charge1 = new ChangeChargeByPrice(charge1);
        System.out.println("개수 + 가격에 따른 할인 수수료 : " + charge1.checkCharge(tradeItem));
    }
}